...
public class SortCodeAcctKeyTransformCallback implements TransformCallback {
    private static final Logger log = Logger.getLogger(SortCodeAcctKeyTransformCallback.class);
    ...
    private Object processResponse(Object obj, AcctKeysConversionContext ctx) {
        ...
        if(formatType != null) {
            AcctKeysConverter converter = findFirstRegisteredConverter(AcctKeysFormatType.SORTCODEPROFILECID, formatType);
    ...
    private Object processRequest(Object obj, AcctKeysConversionContext ctx) {
        ...
        AcctKeysConverter converter = findFirstRegisteredConverter(format, AcctKeysFormatType.SORTCODEPROFILECID);
