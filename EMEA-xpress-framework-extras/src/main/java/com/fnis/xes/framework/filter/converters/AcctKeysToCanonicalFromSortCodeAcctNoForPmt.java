...
public class AcctKeysToCanonicalFromSortCodeAcctNoForPmt extends AcctKeysConverter {

    private static final String CANONICAL_IDENT_TYPE = "Profile";
    private static final Logger log = Logger.getLogger(AcctKeysToCanonicalFromSortCodeAcctNoForPmt.class);
