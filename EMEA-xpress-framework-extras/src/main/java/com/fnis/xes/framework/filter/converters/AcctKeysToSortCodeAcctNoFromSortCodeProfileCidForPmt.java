...
public class AcctKeysToSortCodeAcctNoFromSortCodeProfileCidForPmt extends AcctKeysConverter {

    private static final String CURR_IDENT_TYPE = "SortCodeAcctNo";
    private static final Logger log = Logger.getLogger(AcctKeysToSortCodeAcctNoFromSortCodeProfileCidForPmt.class);
