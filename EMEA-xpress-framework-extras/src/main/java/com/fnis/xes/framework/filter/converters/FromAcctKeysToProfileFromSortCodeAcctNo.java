...
public class FromAcctKeysToProfileFromSortCodeAcctNo extends FromAcctKeysConverter {

    private static final String CANONICAL_IDENT_TYPE = "Profile";
    private static final Logger log = Logger.getLogger(FromAcctKeysToProfileFromSortCodeAcctNo.class);
