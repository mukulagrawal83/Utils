...
public class ToAcctKeysToSortCodeAcctNoFromSortCodeProfileCidForPmt extends ToAcctKeysConverter {

    private static final String CURR_IDENT_TYPE = "SortCodeAcctNo";
    private static final Logger log = Logger.getLogger(ToAcctKeysToSortCodeAcctNoFromSortCodeProfileCidForPmt.class);
