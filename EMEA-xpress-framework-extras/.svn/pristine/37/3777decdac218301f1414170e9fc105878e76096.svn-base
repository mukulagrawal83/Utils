 ...
 * Date: 2/8/13
 */
public class AcctKeysToSortCodeProfileCidFromSortCodeAcctNoForPmt extends AcctKeysConverter {

    private static final String CUR_ACCT_IDENT_TYPE = "SortCodeProfileCid";
    private static final Logger log = Logger.getLogger(AcctKeysToSortCodeProfileCidFromSortCodeAcctNoForPmt.class);
