...
public class ToAcctKeysXBOTransformationFilter extends GenericXBOTransformationFilter {
    private static final Logger log = Logger.getLogger(ToAcctKeysXBOTransformationFilter.class);
    ...
    protected Object handleRequest(RequestMessage rq, Object passedCtx) throws ServiceException {
        ToAcctKeysConversionContext ctx = new ToAcctKeysConversionContext();
    ...
    protected Object handleResponse(ResponseMessage rs, Object passedCtx) throws ServiceException {
        XBOTransformSubject transformSubject;
        ToAcctKeysConversionContext ctx = (ToAcctKeysConversionContext) passedCtx;

        setDefaultIncomingToAcctKeysFormatIfNotDefined(ctx);
    ...
    private void setDefaultIncomingToAcctKeysFormatIfNotDefined(ToAcctKeysConversionContext ctx) {
