 ...
 * Date: 2/8/13
 */
public class AcctKeysToSortCodeAcctNoFromCanonical extends AcctKeysConverter {

    private static final String CUR_ACCT_IDENT_TYPE = "SortCodeAcctNo";
    private static final Logger log = Logger.getLogger(AcctKeysToSortCodeAcctNoFromCanonical.class);
